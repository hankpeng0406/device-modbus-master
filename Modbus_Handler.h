...
#define MAX_BIT_BLOCK_LENGTH 2040
#define MAX_REGISTER_BLOCK_LENGTH 128
...
typedef struct {
	...
	char devicename[HANDLER_NAME_LENGTH];
...
typedef struct WISE_Device_t
{
	char devicename[SENSOR_NAME_LENGTH];
	char filename[SENSOR_NAME_LENGTH];
	int deviceID;
	int numberOfDI;
	int numberOfAI;
	int numberOfDO;
